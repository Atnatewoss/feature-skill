...
Before touching code, run `registry-skills/implementation-plan.md` to structure the approach:
...
Once planned, use `registry-skills/implementation-todo.md` to track your progress step-by-step.

## Step 2 — Check for existing patterns

Before inventing anything, run `registry-skills/folder-tree.md` to analyze the repo context:
...
- If things break or tests fail, loop through `registry-skills/code-fix.md` to systematically debug.
...
Use `registry-skills/commit-push-pr.md` to finalize the delivery:
